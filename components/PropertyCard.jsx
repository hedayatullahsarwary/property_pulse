    ...
    <div className="rounded-xl shadow-md relative">
      ...
      <div className="p-4">
        ...
        <div className="flex justify-center gap-4 text-gray-500 mb-4">
          ...
          <p>
            <i className="fa-solid fa-ruler-combined"></i> 1,500 <span className="md:hidden lg:inline">sqft</span>
          </p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row justify-between mb-4">
          ...
          <a href="property.html" className="h-[36px] bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg text-center text-sm">
            Details
          </a>
        </div>
      </div>
